...
namespace FanaBridge.Display.Rules
{
    ...
    /// legacy rules (and ITM rules targeting <see cref="TargetKind.SegmentScreen"/>) pick
    ...
    public class LegacyScreen
    {
        ...
        /// positions. Delegates to <see cref="SegmentText.IsRenderableText"/> (schema-neutral
        /// single source of truth).
        /// </summary>
        public static bool IsRenderableText(string text)
            => FanaBridge.Display.SegmentText.IsRenderableText(text);
        ...
        public static bool IsRenderableMessage(string text)
            => FanaBridge.Display.SegmentText.IsRenderableMessage(text);
    }
}
