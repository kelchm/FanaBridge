...
{
    /// <summary>
    /// Phase E5: pure FrameComposer tests — layer/field ladders, capability gating (§14),
    /// buffer-continuity, route-law paint, composed-resolution presence, merge law,
    /// and the review-hardened parity gate against a real v9 DisplayRuleStack harness.
    /// Probe traces from e5-composer-opus.json are encoded as named fixtures.
    /// </summary>
  ...
  ""segmentDisplay"": {{
    ...
    ""rules"": []
        ...
        private sealed class DictReader : IPropertyReader
        {
            ...
            public DictReader(double value) => _value = value;
