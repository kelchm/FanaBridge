...
namespace FanaBridge.Tests.Display
{
    ...
    public class Schema2FrozenKeyInventoryTests
    {
        ...
        private static readonly string FrozenInventory = string.Join("\n", new[]
        {
            ...
            "DisplayConfigV2: cycles, fields, pageOrder, pages, priority, profileId, schemaVersion, settings, wheelScreen",
            ...
            "CatalogField: displayLabel, fieldId, firmwareLabel, header, overridable, paramId, primaryHost, provisional, region, shortCode, suffix, value",
            "CatalogPage: fields, id, index, name, provisional",
            ...
            "ItmCatalogSection: legacyPageIndex, pages, transitions",
